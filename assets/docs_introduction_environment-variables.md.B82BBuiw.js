import{_ as a,c as s,o as n,a5 as e}from"./chunks/framework.Da9tFoQ2.js";const m=JSON.parse('{"title":"Environment Variables","description":"","frontmatter":{},"headers":[],"relativePath":"docs/introduction/environment-variables.md","filePath":"docs/introduction/environment-variables.md"}'),t={name:"docs/introduction/environment-variables.md"},i=e(`<h1 id="environment-variables" tabindex="-1">Environment Variables <a class="header-anchor" href="#environment-variables" aria-label="Permalink to &quot;Environment Variables&quot;">​</a></h1><h2 id="setup" tabindex="-1">Setup <a class="header-anchor" href="#setup" aria-label="Permalink to &quot;Setup&quot;">​</a></h2><p>This solution makes use of <a href="https://www.npmjs.com/package/dotenv-cli" target="_blank" rel="noreferrer">dotenv</a> to easily setup environment variables on your machine that are <s>used</s> required for the application to run properly.</p><p>To setup your environment variables, copy and rename the <code>env.dart.template</code> file to <code>env.dart</code>. Then fill in the values for all the keys that you need, more on that below.</p><h2 id="format-of-the-env-files" tabindex="-1">Format of the .env files <a class="header-anchor" href="#format-of-the-env-files" aria-label="Permalink to &quot;Format of the .env files&quot;">​</a></h2><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>KEY1=value</span></span>
<span class="line"><span>KEY2=&quot;value with spaces&quot;</span></span></code></pre></div><h2 id="env-template" tabindex="-1">.env.template <a class="header-anchor" href="#env-template" aria-label="Permalink to &quot;.env.template&quot;">​</a></h2><p>Contains the keys of expected environment variables. It should not contain any sensitive information.</p><details class="details custom-block"><summary>View contents</summary><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>VITE_NMSUD_FORM_WEB_URL=http://localhost:3001</span></span>
