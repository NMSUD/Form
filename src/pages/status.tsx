...
export const StatusPage: Component = () => {
    ...
    const recordIdValidation = multiValidation<string>(
        minLength(10),
        maxLength(50),
    );
    ...
    const searchAndDisplay = async (localSegment: Array<string>, localRecordId: string) => {
        ...
        const dtoResult = await getFormStatusApiService().getRecordFromApi<IFormWithApprovalResponse>(localRecordId, localSegment[0]);
                ...
                <Card class="form">
                    ...
                    >
                        ...
                        <HStack
                            ...
                            w="$full"
                        >
                            <Avatar name="approval status icon" src={getImageFromFormResponse(formResponse())} mr="$3" />
