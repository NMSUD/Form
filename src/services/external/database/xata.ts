...
const tables = [
  ...
  },
  {
    ...
    revLinks: [
      ...
      { column: 'builder', table: 'planetBaseBuilder' },
    ],
  },
  {
  ...
  },
  {
    ...
    revLinks: [{ column: 'planetBase', table: 'planetBaseBuilder' }],
  },
  {
    name: 'planetBaseBuilder',
    columns: [
      { name: 'planetBase', type: 'link', link: { table: 'planetBase' } },
      { name: 'builder', type: 'link', link: { table: 'builder' } },
    ],
  },
] as const;
...
export type PlanetBase = InferredTypes['planetBase'];
export type PlanetBaseRecord = PlanetBase & XataRecord;

export type PlanetBaseBuilder = InferredTypes['planetBaseBuilder'];
export type PlanetBaseBuilderRecord = PlanetBaseBuilder & XataRecord;

export type DatabaseSchema = {
  community: CommunityRecord;
  builder: BuilderRecord;
  communityBuilder: CommunityBuilderRecord;
  planetBase: PlanetBaseRecord;
  planetBaseBuilder: PlanetBaseBuilderRecord;
};
